...
const FilterSidebar = ({
  ...
  const defaultSsdOptions = ["256 GB", "512 GB"];
  ...
  const showBrands = !filterConfig || filterConfig.brands;
  const showPriceRange = !filterConfig || filterConfig.priceRange;
  const ramOptions = (filterConfig && filterConfig.rams) || defaultRamOptions;
  const showRam = !!(filterConfig && filterConfig.rams);
  const ssdOptions = (filterConfig && filterConfig.ssds) || defaultSsdOptions;
  const showSsd = !!(filterConfig && filterConfig.ssds);
  const colorOptions =
    (filterConfig && filterConfig.colors) || defaultColorOptions;
  const showColors = !!(filterConfig && filterConfig.colors);
        ...
        {!filterConfig && (
          <>
            <CheckboxFilter
              ...
              onChange={(screenSizes) =>
                onFilterChange("screenSizes", screenSizes)
              }
              showAll={true}
            />
            ...
            <CheckboxFilter
              ...
              onChange={(resolutions) =>
                onFilterChange("resolutions", resolutions)
              }
              showAll={true}
            />
